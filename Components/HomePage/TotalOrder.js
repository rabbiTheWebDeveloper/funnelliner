...
const TotalOrder = () => {
  ...
  const onSubmit = (data) => {
    axios
      .post(baseLocal + "/client/sales-target/update", data, {
        headers: headers
      })
  ...
  const handleFetchSellsTarget = async () => {
    try {
      let data = await axios({
        method: "get",
        url: `${baseLocal}/client/sales-target`,
        headers: headers,
      });
            ...
            <Grid item xs={8}>
              <div className='SalesTarget d_flex d_justify'>
                ...
                <div className='TotalOrderItem'>
                  ...
                  <div className='Main'>
                    <h3>{salesTarget?.daily?.toLocaleString('en-US') || ''}</h3>
                    {/* {min_salary?.toLocaleString('en-US') || ''} */}
                        ...
                        <div className='SalesTargetModal'>
                          ...
                          <div className='Form'>
                            <form onSubmit={handleSubmit(onSubmit)}>
                              ...
                              <div className='CustomeInput'>
                                <label>
                                  Enter Weekly Sales Target (in BDT)
                                </label>
                                <TextField
                                  id='outlined-basic'
                              ...
                              <div className='CustomeInput'>
                                <label>
                                  Enter Monthly Sales Target (in BDT)
                                </label>
                                <TextField
                                  id='outlined-basic'
                ...
                <div className='TotalOrderItem'>
                  ...
                  <div className='Main'>
                    ...
                    <h6 className='CancelOrder'>
                      <span>Order Cancelled:</span> 188/590
                    </h6>
                  </div>
                </div>
              </div>
